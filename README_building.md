...
#### (1.c) Configuring via cmake-gui:

To use the GUI of the cmake:

1.c.1) Open cmake-gui from the project directory:

```
cmake-gui .
```

1.c.2) Set the build directory:

![build_dir](https://user-images.githubusercontent.com/16418197/82524586-fa48e380-9af4-11ea-8514-4e18a063d8eb.jpg)

1.c.3) Configure the generator:
...
1.c.4) Choose the Cmake options and then generate:
...
### Running the tests (if we ever have them)
